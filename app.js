...
(function () {
  ...
  function renderStudentsTab() {
    ...
    document.getElementById("btnAddStudent").addEventListener("click", () => {
      ...
      const start = CATEGORY_START[studentForm.category] || 100;
      const count = state.students.filter((s) => s.category === studentForm.category).length;
      const chestNo = String(start + count);
      state.students.push({
