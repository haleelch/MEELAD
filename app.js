...
(function () {
  ...
  // Guest Mode always exits ALL the way back to the site home page — from
  // either Super Admin or Admin. It closes every screen directly instead of
  // unwinding history.back() one step at a time, because that chain could
  // get out of sync when screens were opened in quick succession (sidebar ->
  // login -> admin panel), which was why Guest Mode sometimes did nothing.
  ...
  function renderPosterTab() {
    ...
    adminContent.innerHTML = `
      ...
      <div class="card">
        ...
        <div class="field-label" style="margin-bottom:.5rem">One background photo for the whole "at a glance" box (Total Programmes / Participants / Teams / Points together) \u2014 not a separate photo per number. The numbers and labels stay on top.</div>
  ...
  function renderCardsTab() {
    ...
    adminContent.innerHTML = `
      ...
      <div class="card">
        ...
        <button class="btn btn-primary" id="btnDownloadTestCard" style="width:auto;padding:.5rem .9rem${super_ ? ";margin-bottom:1rem" : ""}">\u2B07 Chest No DOWNLOAD</button>
