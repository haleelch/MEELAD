...
(function () {
  ...
  function defaultCardPlacements() {
    return [
      { id: "pl-" + uid(), tag: "student_name", fontSize: 50, weight: 700, color: "#000" },
      { id: "pl-" + uid(), tag: "chest_number", fontSize: 47, weight: 600, color: "#000" },
      { id: "pl-" + uid(), tag: "category", fontSize: 47, weight: 600, color: "#000" },
      { id: "pl-" + uid(), tag: "team_name", fontSize: 36, weight: 400, color: "#000" },
    ];
  }
